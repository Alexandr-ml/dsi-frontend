...
function TareasTable({listaTareas,actualizarTareas,proyecto}){
            ...
            <TableContainer sx={{height:450,maxHeight:450}}>
                <Table>
                    ...
                    <TableBody>
                        ...
                        {
                            listaTareas.map((value,index) => <RowTarea tarea={value} actualizarTareas={actualizarTareas}  setSeModificaronTareas={setSeModificaronTareas} proyecto={proyecto}/>)
                        }
...
function RowTarea({tarea,actualizarTareas,setSeModificaronTareas,proyecto}){
    ...
    const borrarTarea = ()=> {
        ...
        fetch(serverUrl+`/api/tareas/${tarea.uid}`,initBorrarTarea)
            .then(raw => {
                ...
                if(raw.ok){
                    return fetch(serverUrl+`/api/tareas/listadoTareas/${id}`,initGetTareas)
                }
            })
